  ...
  return (
    <div className="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
      ...
      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        <a class="me-3 py-2 text-dark text-decoration-none" href="#">Profiles</a>
        ...
        <div>
          <button type="button" class="btn ms-3 py-2 btn-outline-dark btn-sm text-decoration-none">Log out</button>
        </div>
      </nav>
    </div>
  );
